...
$(document).ready(function () {
	...
	active_mode = function () {
		...
		$("#situationAccident").addClass("nav-active")
	...
	get_dt = function (pageload='') {
		...
		$('#dataTable').DataTable({
			...
			"columnDefs": [{ orderable: false, targets: [ 2, 5, 13, 34] }],
			"order": [[1, "desc"]],
			"ajax": {
				"url": "../../../models/situation/getdt_accidents.hh",
				"type": "POST",
				"data": function (d) {
					d.from = from;
					d.to = to;
				...
				'dataSrc': function (res) {
					...
					for (var i = 0; i < check.length; i++) {
						return_data.push({
							...
							"createmodel": `<span class="createmodel" scn="${check[i].SystemCodeNumber}" type="accident">Create</span> / <a href="./view_situation_model.html?scn=${check[i].SystemCodeNumber}&type=accident" target="_blank">View</a> / <span class="downloadmodel" scn="${check[i].SystemCodeNumber}" type="accident">Download</span>`
						})
					}
					return return_data;
				}
			...
			"fnDrawCallback": function (oSettings) {
				...
				//  $('td:nth-child(4),td:nth-child(5),td:nth-child(7),td:nth-child(11),td:nth-child(12),td:nth-child(13),td:nth-child(16),td:nth-child(15),td:nth-child(17),td:nth-child(18),td:nth-child(19),td:nth-child(20),td:nth-child(21),td:nth-child(22),td:nth-child(23),td:nth-child(24),td:nth-child(25),td:nth-child(26),td:nth-child(27),td:nth-child(28),td:nth-child(29),td:nth-child(30),td:nth-child(31),td:nth-child(32),td:nth-child(33),td:nth-child(34)', this).css('display', 'none')
				...
				$('.viewdetails').click(function () {
					...
					window.location.href='view_details.html?module=accident&id=' + $('.a_scn', ele).html();
				...
				$('.createmodel').click(function () {
					...
					var scn = $(this).attr('scn'),
						type = $(this).attr('type')
					var url = `${document.location.protocol}//${GLOBAL.SUMO.IP}:${GLOBAL.SUMO.PORT}/run_model/incident/${scn}/type/4/create`;
					console.log(url)
	...
	$('#add_acc_btn').click(function () {
		...
		// data_entry_list = [{"item":"Camera","value":"true"}];
		data_entry_list = []
				...
				$.ajax({
					...
					success: function (res) {
						$.alert({
							...
							content: '<div class="fw-bold">Situation edited successfully</div>'
						});
						// location.reload();
					}
				});
	...
	// 			method: 'POST',
	// 			data: { SystemCodeNumber: delRecord, type: "accident" },
	// 			success: function (res) {
	// 				if (res)
	// 					location.reload();
