...
$(document).ready(function () {
    ...
    $('#add_acc_btn').click(function () {
        ...
        var acc_datetime = sanitize($('.acc_datetime').val());   
        ...
        if ((situationType == "accident" || situationType == "incident" || situationType == "crime") && acc_datetime == "") {
            $.alert({
                type: 'red',
                title: '<h3 class="text-danger fw-bold mb-0">Message</h3>',
        ...
        //         type: 'red',
        //         title: '<h3 class="text-danger fw-bold mb-0">Message</h3>',
        //         content: '<div class="fw-bold">Please Enter Situation Time</div>'
        //     });
        //     return;
        // }
        ...
        var datetime = currentdate.getFullYear() + "-" + ((currentdate.getMonth() + 1) < 10 ? '0' : '') + (currentdate.getMonth() + 1) + "-"+ ((currentdate.getDate() + 1) < 10 ? '0' : '') +
            + currentdate.getDate() + " " + currentdate.getHours() + ":" + currentdate.getMinutes() + ":" + currentdate.getSeconds();
        if (mid == "accident" || mid == "incident" || mid == "crime") {
            if(Date.parse(accDT) > Date.parse(datetime)){
            $.alert({
                type: 'red',
                title: '<h3 class="text-danger fw-bold mb-0">Message</h3>',
