...
$(document).ready(function () {
	...
	// 		$("#actual_start").attr("disabled", true);
	// 		$("#actual_end").attr("disabled", true);
	// 	}
	// 	if(!plannedStart) {
	...
	// 		if (actualStart !== null){
	// 			$("#planned_start").attr("disabled", true);
	// 			$("#planned_end").attr("disabled", true);
	// 	}
	// 	if (!actualStart){
	...
	$('#add_acc_btn').click(function () {
		...
		Contraflow = sanitize($('input[name=q5]:checked').val());
		TrafficSignals = sanitize($('input[name=q6]:checked').val());
		// Contractor = sanitize($('#contractor').val());
		...
		// if (PlannedStart != '') {
		// 	PlannedStart = getFormattedDate(PlannedStart, 'd-m-y H:m:s', 'Y-m-d H:m:s');
		// }

		// if (PlannedEnd != '') {
		// 	PlannedEnd = getFormattedDate(PlannedEnd, 'd-m-y H:m:s', 'Y-m-d H:m:s');
		// }
		// if (ActualStart != '') {
		// 	ActualStart = getFormattedDate(ActualStart, 'd-m-y H:m:s', 'Y-m-d H:m:s');
		// }
		// if (ActualEnd != '') {
		// 	ActualEnd = getFormattedDate(ActualEnd, 'd-m-y H:m:s', 'Y-m-d H:m:s');
		// }
